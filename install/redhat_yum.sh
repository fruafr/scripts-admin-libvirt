#!/bin/bash
# redhat_yum.sh
# Install libvirt/KVM on RedHat Family distributions (CentOS) using yum
...
{
   # Display Help
   echo "Install libvirt/KVM on RedHat Family distributions (CentOS) using yum"
...
#sudo yum install -y @virt
#is equivalent to
sudo yum install -y qemu-kvm libvirt libguestfs-tools
#add additional packages
sudo yum install -y bridge-utils virt-install libosinfo
